## Quantify infected hosts and infected patches contributed by transient versus
## persistent infection episodes. This reruns the established-analysis scenario
## set with identical seeds and model logic, but writes only to a new directory.
...
outdir <- here::here("fadeout", "output", "transient_patch_analysis")
...
if (plot_only) {
  ...
  message("Plot-only mode: using existing corrected source-pressure data")
} else {
