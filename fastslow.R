...
dat3 <- filter(res1T,
               startsWith(as.character(var), "cum")) |> droplevels()
gg3 <- (gg0 %+% dat3) +
    aes(colour = var) +
    scale_y_log10() +
    labs(title = "cumulative FOI/prevalence")
