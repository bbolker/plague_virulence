...
\label{eq:regime}
\end{equation}
[[JD: 100\% agree with BB here: always avoid saying things are small without a scale-appropriate comparator.]]
...
[[JD: Might even be good to briefly describe the scale separation before talking about the breakdown.]]
...
\begin{align}
[[JD: Probably prefer $\approx$ to $\simeq$ everywhere.]]
...
\end{align}
[[JD: It seems OK to use equality above: Pburn can mean the true Pburn, and the approximation in the first equation above is marked as an approximation.]]
