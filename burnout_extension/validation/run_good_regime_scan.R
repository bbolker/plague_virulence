...
checkpoint_file <- 'validation/data/good_regime_scan_checkpoint.rds'
results_file <- 'validation/data/good_regime_scan_results.csv'
...
atomic_save(state)
cat('good-regime stochastic scan complete\n')
