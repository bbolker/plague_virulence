...
* effects of demography, time scale on single-species, single-patch outcomes
* effects of $R_0$ on patch occupancy in metapopulations
    * parameter regimes where decreasing $R_0$ **increases** patch occupancy/persistence
* is lower $R_0$ selected in these regimes?
* how do patch carrying capacity and connectivity affect these results?

## effects of demography and timestep

![](pix/euler_onepatch_onestrain_comb.png)

## logistic/continuous

![](pix/euler_onepatch_onestrain_extinct_logistic_continuous.png)

## one-species metapopulation results

![](pix/analytic_MP_occ.png)
