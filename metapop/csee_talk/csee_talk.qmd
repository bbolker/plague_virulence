...
* **Yuyang Zhang**, Jonathan Dushoff, David Earn
...
## tradeoff theory and why it doesn't work here
...
* **epidemic initiation**
   * \# infected fleas from each patch $\propto$ total epidemic size
...
## caveats and open questions (lots!)
